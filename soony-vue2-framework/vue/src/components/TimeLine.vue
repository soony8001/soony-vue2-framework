<template>
	<v-card class="mx-auto timeline" max-width="380">
		<v-card dark flat>
			<v-btn absolute bottom color="pink" right fab @click="onAddPerson">
...
export default {
	data() {
		return {
			avatarIcon:
				'https://avataaars.io/?avatarStyle=Transparent&topType=ShortHairDreads01&accessoriesType=Prescription02&hairColor=Brown&facialHairType=BeardLight&facialHairColor=Blonde&clotheType=GraphicShirt&clotheColor=Heather&graphicType=SkullOutline&eyeType=Happy&eyebrowType=RaisedExcited&mouthType=Twinkle&skinColor=Yellow',
		}
	},
